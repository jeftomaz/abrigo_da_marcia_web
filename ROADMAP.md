...
- `done` **Fase 2b — escala tipográfica no admin.** Os 15 tokens `--text-*` passaram ao tema compartilhado; admin e público agora medem igual. Encolhimentos a conferir na revisão visual: `text-4xl` cai de 36 px para 28,8 px até 1920 px (16 usos) e `text-sm` cai de 14 px para 11,9 px em 320 px (93 usos). E2E de layout do admin em 320/375/430 px continua passando.
